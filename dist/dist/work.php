...
<body>
    ...
    <main id="about">
        ...
        <div class="projects">
            <div class="item">
                <a target='_blank' href="https://voetbal.be">
                    <img src="img/voetbal.jpg" alt="project">
                </a>
                <a target='_blank' href="https://voetbal.be" class="btn btn-light">
            ...
            <div class="item">
                ...
                <a target='_blank' href="#" class="btn btn-light">
            ...
            <div class="item">
                <a target='_blank' href="http://localhost/monsterVue">
                    <img src="img/monster.jpg" alt="project">
                </a>
                <a target='_blank' href="http://localhost/monsterVue" class="btn btn-light">
            ...
            <div class="item">
                <a target='_blank' href="http://localhost/school/public/">
                    <img src="img/index.jpg" alt="project">
                </a>
                <a target='_blank' href="http://localhost/school/public/" class="btn btn-light">
